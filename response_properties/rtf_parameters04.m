...
function  [RTFparam]=rtf_parameters04(RTF,RD,Fm)

% % plot RTF
% figure; figuresetup2seeonthescreen;
% RTF4plot = RTF./sum(sum(RTF));
% RTF4plot = flipud(RTF4plot);
...
% hold on;
% plot(Fmu,tMTFu,'k')
% line([min(Fm) max(Fm)],[.7 .7],'Color','k','LineWidth',1,'LineStyle',':');
% line([tMTF_Min tMTF_Min],[0 1.2],'Color','r','LineWidth',1,'LineStyle',':');
% line([tMTF_Max tMTF_Max],[0 1.2],'Color','r','LineWidth',1,'LineStyle',':');
% line([tMTF_Min2 tMTF_Min2],[0 1.2],'Color','b','LineWidth',1,'LineStyle',':');
% line([tMTF_Max2 tMTF_Max2],[0 1.2],'Color','b','LineWidth',1,'LineStyle',':');
% line([tBMF tBMF],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
% line([tBMF2 tBMF2],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
...
% hold on;
% plot(RDu,sMTFu,'k')
% line([0 max(RD)],[.7 .7],'Color','k','LineWidth',1,'LineStyle',':');
% line([sMTF_Min sMTF_Min],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
% line([sMTF_Max sMTF_Max],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
% line([sBMF sBMF],[0 1.2],'Color','r','LineWidth',1,'LineStyle',':');
% line([sMTF_Min2 sMTF_Min2],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
% line([sMTF_Max2 sMTF_Max2],[0 1.2],'Color','k','LineWidth',1,'LineStyle',':');
% line([sBMF2 sBMF2],[0 1.2],'Color','b','LineWidth',1,'LineStyle',':');
% ylim([0 1.2])
